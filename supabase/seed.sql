-- Insert categories with NULL embeddings
...
-- Insert menu items with NULL embeddings
INSERT INTO menu_items (name, description, price, category_id, image_url, embedding) VALUES
  (
    'Classic Sourdough',
